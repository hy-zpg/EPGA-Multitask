...
# def load_image(paths: np.ndarray, size: int):
#     images = []
...
class DataGenerator(Sequence):
    ...
    def __getitem__(self, idx: int):
        ...
        # print('gender_age_path',paths_gender_age)
        batch_x_gender_age = load_image( paths_gender_age, self.input_size,self.input_shape[0])
        ...
        batch_x_emotion = load_image(paths_emotion, self.input_size,self.input_shape[0])
