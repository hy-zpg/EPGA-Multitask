...
from utils.confusion_MTL.confusion_EGA_generator import DataGenerator
...
def main():
    ...
    if not args.is_freezing:
        ...
        for epoch in  range(EPOCH):
            ...
            model.fit_generator(
                DataGenerator(model,model_pre,train_emotion_paths,train_gender_age_paths,train_emotion,train_gender,train_age,args.batch_size,args.is_distilled,args.is_pesudo,args.is_interpolation,args.selection_threshold,args.interpolation_weights,is_augmentation=args.is_augmentation),
                validation_data = DataGenerator(model, None,test_emotion_paths,test_gender_age_paths, test_emotion,test_gender,test_age,args.batch_size,args.is_distilled,args.is_pesudo,args.is_interpolation,args.selection_threshold,args.interpolation_weights,is_augmentation=False),
                epochs=1,
                verbose=2,
                workers=1,
